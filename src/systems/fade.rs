...
use crate::resources::fade::Fader;
...
impl<'s> System<'s> for FadeSystem {
    type SystemData = (WriteStorage<'s, Fader>, WriteStorage<'s, Tint>, Read<'s, Time>);
    ...
    fn run(&mut self, (mut faders, mut tints, time): Self::SystemData) {
